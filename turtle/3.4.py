...
# Starting the process of the game with a loop 
for rounds in range(20):
    ...
    if player_two.pos() >= (300, -100):
        ...
        die_roll_result = random.choice(die)
        print("The result of the die roll is: ")
        print(die_roll_result)
        print("The number of steps will be: ")
        print(20*die_roll_result)
        player_one.fd(die_roll_result*20)
        ...
        print("The number of steps will be: ")
        print(20 * die_roll_result)
        player_two.fd(20*die_roll_result)
